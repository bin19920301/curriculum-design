...
public class MyCommentGenerator implements CommentGenerator {
	...
	/**
	 * This method adds the custom javadoc tag for. You may dao nothing if you dao
	 * not wish to include the Javadoc tag - however, if you dao not include the
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable,
		...
		if (actualColumnName.equals("f_id")) {
			field.addJavaDocLine("@Id");
			field.addJavaDocLine("@GeneratedValue(strategy = GenerationType.IDENTITY)");
		}

		StringBuilder column = new StringBuilder();
		column.append("@Column(name = \"").append(actualColumnName).append("\")");
		field.addJavaDocLine(column.toString());

		if (actualColumnName.equals("f_create_time") || actualColumnName.equals("f_update_time")) {
			field.addJavaDocLine("@Temporal(TemporalType.TIMESTAMP)");
		}
